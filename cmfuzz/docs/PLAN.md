...
- [~] 2.2 差分算法扩展(SHA-3/公钥…)——已接 SHA-3 家族(op5–8: SHA3-256/512、SHAKE128/256)
      与 KDF(op9 HKDF-SHA256、op10 PBKDF2-HMAC-SHA256)，四~五方一致；待续公钥
      (RSA-PSS/OAEP、ECDSA P-256、Ed25519、X25519)。AEAD 模式(CCM/OCB/GCM-SIV)因
      OpenSSL/后端支持不齐暂缓
