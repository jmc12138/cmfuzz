...
- [x] 阶段0 L1 四 oracle
- [ ] 1.1 HPKE 组合(O5)
- [ ] 1.2 传统组合 Encrypt-then-MAC / TLS1.3 记录层(O5)
- [ ] 1.3 KEM+SIG 组合 & KDF 链(O5)
- [ ] 1.4 AEAD nonce 重用 / EVP 状态机误用(O6，传统)
- [ ] 1.5 ECDSA k 复用 & PQC API 误用(O6)
- [ ] 2.1 +BoringSSL/aws-lc/wolfCrypt/Botan
- [ ] 2.2 差分算法扩展(SHA-3/公钥…)
